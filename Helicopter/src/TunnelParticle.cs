...
namespace Helicopter
{
  public class TunnelParticle
  {
    ...
    public void Draw(SpriteBatch spriteBatch) => spriteBatch.Draw(Global.tunnelStar, this.position_, new Rectangle?(), new Color(new Vector4(Global.tunnelColor.ToVector3(), 0.75f)), 0.0f, this.origin_, this.scale_, SpriteEffects.None, 0.0f);
